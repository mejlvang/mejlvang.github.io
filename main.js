...
function startMQTT() {
	// This is the address to a public and free MQTT service run by eclipse.org
	// We connect to it in the beginning after clicking a button
	// Be aware that this is not secure because it's public
	client = mqtt.connect('ws://iot.eclipse.org/ws');
